<template>
  <div class="article-container">
    ...
    <div class="main-wrap">
      ...
      <!-- 加载完成-文章详情 -->
      <div  class="article-detail markdown-body" v-else-if="articleDetail.art_id">
        <!-- 文章标题 -->
        ...
        <!-- 文章内容 -->
        <div ref="articleImagesd" class="article-content " v-html="articleDetail.content"></div>
...
import { getArticlrDetailAPI } from '@/api'
